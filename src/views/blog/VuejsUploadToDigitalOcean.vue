<template>
  <div class="content">
    ...
    <div class="list-content">
      <ol>
        ...
        <li>
          In your terminal navigate to the master branch verify that all changes have been pushed to github and the repository is clean.
        </li>
        ...
        <li>
          Now use git add, then git commit and push the new dist files to the master branch on github.
        </li>
        ...
        <li>
           In your terminal on the command line, create a branch called production by typing:<br>
        ...
        <li>
          ...
          <br><code>git checkout master -- dist</code>
        </li>
        ...
        <li>
          ...
          <ul>
            <li>a. <code>git add dist</code></li>
        ...
        <li>
          ...
          <br>Create an empty folder called "myvuejsapp" by typing <br>
        ...
        <li>
          ...
          called myvuejsapp, in the command line type:<br><code>git pull origin production</code><br> 
          Type <code>ls</code> to veryify the folder was uploaded.
        </li>

        <li>
          Next we have to tell the server which folder to open when traffic is coming in form your domain. This assumes you
          have a domain name pointing to your <a href="https://m.do.co/c/3ec7cdf44173" target="blank">Digital Ocean</a> Droplet.
  ...
  &lsaquo;/VirtualHost&rsaquo;</code></pre>
        ...
        <li>
          Congradulations your site should now be live!
        </li>

         <li>
           View the <a v-bind:href ="''+url+''" target="blank">Gist</a>
        </li>
      </ol>
    </div>
  </div>
