<template>
  <div class="content">
    ...
    <p>
      ...
      This tutorial assumes you already have a Digital ocean Droplet and a Github account and
      your <a href="https://vuejs.org/v2/guide/installation.html" target="blank">Vue.js</a>
    ...
    <div class="list-content">
      <ol>
        ...
        <li>From the command line run <code>npm run build</code> or run build from the
        ...
        <li>
          ...
          proceed to step 7. If the dist folder is in yoru repository skip to step 8.
        </li>

        <li>
          We will need to remove and cache all files. In the command line type:
          <ul>
            <li>a. <code>git rm -r --cached</code></li>
            <li>b. <code>git add . or git add --all</code></li>
            <li>c. <code>git commit -m "untrack files in .gitignore"</code></li>
          </ul>
        ...
        <li>In your terminal on the command line, create a branch called production by typing: git branch production</li>

        <li>Now checkout the production branch by typing:<br><code>git checkout production</code></li>

        <li>
          We want to move the dist folder from the master branch to the production branch.
          In the command line type:<br><code>git checkout master --dist</code>
        </li>
        ...
        <li>
          ...
          <ul>
            <li>a. <code>git all dist</code></li>
            <li>b. <code>git commit -m "deploy to production"</code></li>
            <li>c. <code>git push origin production</code></li>
          </ul>
        </li>

        <li>Go to Github and verify the dist folder is now in the production branch. On the left side above the folders and to the left
        ...
        <li>
          ...
          called myvuejsapp, in the command line type:<br><code>git pull origin production</code><br> Run <code>ls</code> to veryify the folder was
          uploaded.
        </li>

        <li>
          Next we have to tell the server which folder to open when traffic is coming in form your domain. Ths assumes you
          you have a domain name pointing to your <a href="https://m.do.co/c/3ec7cdf44173" target="blank">Digital Ocean</a> Droplet.
          Open /etc/apache2/sites-enabled/000-default.conf by typing the following in the command line:<br>
  ...
  &lsaquo;/VirtualHost&rsaquo;</code></pre>
        ...
        <li>
           Close the file and restart Apache by typing:<br><code>service apache2 restart</code>
        </li>
